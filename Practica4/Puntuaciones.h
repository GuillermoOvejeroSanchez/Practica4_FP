...
void liberar(tPuntuaciones & clasificacion, tInfoJugador**& alfabetico); //Libera la memoria dinamica de la clasificacion y del ranking alfabetico
...
tInfoJugador** ordenAlfabetico(const tPuntuaciones& puntuaciones); //Ordena las puntuaciones por orden alfabetico
void mostrarAlfabetico(tInfoJugador**& alfabetico, const tPuntuaciones& puntuaciones); //Muestra en orden alfabetico
#endif